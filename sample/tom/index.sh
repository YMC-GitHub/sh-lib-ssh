...
# file usage
# sample/tom/index.sh
# sample/tom/index.sh "192.168.56.18" "root" "20-06-25" ~/.ssh/ 22
# sample/tom/index.sh "$SSH_SERVER_IP" "$SSH_USER_NAME" "$SSH_KEY_FILE_NAME" "$SSH_PRI_KEY_FILE_PATH" $SSH_SERVER_PORT
